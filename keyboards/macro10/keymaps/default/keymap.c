...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE]=LAYOUT(
    // TD(TO_SETTINGS),
    // KC_7, KC_8, KC_9, LGUI(KC_TAB),
    // KC_4, KC_5, KC_6, LGUI(KC_C),
    // KC_1, KC_2, KC_3, LGUI(KC_V),
    // KC_0, KC_DOT, KC_ENT, MO(_EXTRA)),

    KC_BSPC, KC_Q,     KC_W, KC_E,
    KC_A,    KC_S,     KC_D, KC_F,
    _______, KC_LCTRL, MO(_EXTRA), SEXY_GIRL),

    [_EXTRA]=LAYOUT(
    SEL_BLE, _______, _______, _______,
    _______, _______, _______, _______,
    _______, _______, _______, _______),

    [_SETTINGS]=LAYOUT(
    // TO(_BASE),
    // ENT_SLP, XXXXXXX, XXXXXXX, XXXXXXX,
    // ENT_DFU, XXXXXXX, XXXXXXX, XXXXXXX,
    // TOG_HID, XXXXXXX, XXXXXXX, XXXXXXX,
    // DELBNDS, XXXXXXX, XXXXXXX, XXXXXXX),
    _______, _______, _______, _______,
    _______, _______, _______, _______,
    _______, _______, _______, _______),
};
